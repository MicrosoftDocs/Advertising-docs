...
## Microsoft Channel app
[!INCLUDE [ComingSoon](./includes/ComingSoon.md)]
You can connect your Shopify merchant account to shoppers on the Microsoft Search Network and Microsoft Audience Network with just a few steps via the Microsoft Channel app.

## Sign in/Sign up

There are two ways to sign in to the Microsoft Channel app: sign in with your existing Microsoft account or sign up for a new Microsoft account.

1. Sign up for a new account:
   1. From the left menu, select **Microsoft** under **Sales Channels**.
   1. Select **Create** to create a new Microsoft account.
   1. Fill out the **Create your Microsoft Advertising account** form and select **Sign up**.
> [!IMPORTANT]
> To finish sign-up, check your inbox for a confirmation email. Complete the steps mentioned in the email.

1. Sign in with an existing account:
   1. From the left menu, select **Microsoft** under **Sales Channels**.
   1. Select **Sign in to Microsoft account**.
   1. Enter your email address and select **Next**.
   1. Enter your password and select **Sign in**.
   1. Select **Accept** to grant the requested permissions.

## Free product listings access

Once you connect your Microsoft account, all your products are automatically able to show on the Bing Shopping tab for free as product listings. [ Learn more about product listings.](./hlp_BA_CONC_BSC_ProductListings.md)

## Opt-in to Free product listings

1. From the left menu, select **Microsoft** under **Sales Channels**.
1. Select **Get started** under the **Free listings** section.
1. Select your store **Language**, enter a **Store currency**, and select a **Country of sale**. Select **Save**.

> [!NOTE]
> You can also use coupons with your paid listings in Microsoft Advertising.

## "Buy Now" button
[!INCLUDE [ComingSoon](./includes/ComingSoon.md)]
You can display a **Buy Now** button on both your free listings and paid product ads. This button enables shoppers to quickly purchase the products they are interested in. When a shopper selects **Buy Now**, they are sent directly to the shopping cart page and that product is added to the cart.

![Buy Now button](../images/BA_Conc_BMC_Shopify_BuyNow.png)
## Get started

- There is no action needed on your part. The **Buy Now** button will start showing up on a small percentage of your ads to provide additional value for your customers.
- Coming soon, we will offer an opt-out option in the app if you don't want to show the **Buy Now** button. Meanwhile, you can [contact our ad support team](https://go.microsoft.com/fwlink?LinkId=398371) and ask to opt-out of this pilot if you don’t want to showcase this new option for your customers.
