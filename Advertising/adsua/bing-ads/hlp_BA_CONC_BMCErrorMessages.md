...
|---|---|
|The offer does not meet our editorial guidelines.|These product offers violate one or more of our [advertising policies and guidelines](https://go.microsoft.com/fwlink?LinkId=398341).To see a sample of the offers that we have rejected, select **The offer does not meet our editorial guidelines** in the Product issue table. Then, find the corresponding policy violations in the Policy violation details page and go to **View samples**.You can make changes to your rejected offers to comply with the policies and guidelines and then reupload your catalog feed file in Microsoft Merchant Center. Each time you upload a feed file for your store, we automatically check to see if the product offers comply with our policies and guidelines.If you believe we shouldn’t have rejected your offer, you may request a review. [Learn more](./hlp_BA_CONC_BMCHowToAppeal.md)|
