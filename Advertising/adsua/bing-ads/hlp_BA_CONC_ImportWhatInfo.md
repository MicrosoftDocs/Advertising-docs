...
<table>
  ...
  <tr>
    ...
    <td style="text-align:left">
                    Similar to website visitors lists (also called rule-based remarketing lists) that Microsoft Advertising supports
                  </td>
    <td style="text-align:left">
                    Similar to lists that are not based on website visitors (such as customer lists)
                  </td>
  </tr>
  <tr>
    <th scope="row" style="background: transparent">
...
Some bid strategies are not supported in Microsoft Advertising. For unsupported bid strategies, your campaign bid strategy will be set to [enhanced CPC](./hlp_BA_CONC_BidStrategy.md) and bids will be set to an amount we recommend. Please note that you can update these bids after you import them to Microsoft Advertising.
...
|---|---|---|
|Final URL: Microsoft Advertising has a 35-character maximum limit for the host in URL. For example, if the URL is http://www.edu.bing.co.uk/pages/one, then the host is www.edu.bing.co.uk and it can’t be more than 35 characters. Google Ads allows more than 35 characters for the host in URL.|![green check mark](../images/Global_Icon_CheckMark.png)|![green check mark](../images/Global_Icon_CheckMark.png)|
|Headlines: Both text and pin position will be imported.|![green check mark](../images/Global_Icon_CheckMark.png)|![green check mark](../images/Global_Icon_CheckMark.png)|
