...
<table type="type2" style="width:100%;border-spacing:0px;margin-top:25px">
  <tr>
    ...
    <td style="font-size:16px;padding:0px;line-height:17px">JULY 2021</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding-bottom:0px">
      <para style="padding-bottom:2px">
          <strong>
            Manager account level labels</strong> 
        </para>
      <para>
          Create labels at the manager account level to organize your campaigns, ad groups, ads, and keywords. Use these labels at any account level under your manager account. [Learn more about what you can do with labels](./hlp_BA_CONC_Labels.md).
		  </para>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="font-size:16px;padding:0px;line-height:17px">JUNE 2021</td>
  </tr>
  <tr>
    <td rowspan="3" style="padding:0px">
        ![""](../images/spacer.gif)
  ...
  <tr>
    ...
    <td style="padding-bottom:0px">
      <para style="padding-bottom:2px">
          <strong>
            Import campaigns from Facebook Ads</strong> 
        </para>
      <para>
          Save time and expand your brand’s reach by directly importing audience campaigns from Facebook Ads. Now available to all advertisers in the US, CA, UK, AU, FR, DE, and NZ, Facebook Import can be accessed from the global Import menu. [Import from Facebook Ads](./hlp_BA_PROC_Import_FB_Campaign.md).
		  </para>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="font-size:16px;padding:0px;line-height:15px">FEBRUARY 2021</td>
  </tr>
  <tr>
    <td rowspan="3" style="padding:0px">
        ![""](../images/spacer.gif)
  ...
  <tr>
    ...
    <td style="font-size:16px;padding:0px;line-height:15px">JANUARY 2021</td>
  </tr>
  <tr>
    <td rowspan="3" style="padding:0px">
        ![""](../images/spacer.gif)
  ...
  <tr>
    ...
    <td style="font-size:16px;padding:0px;line-height:15px">SEPTEMBER 2020</td>
  </tr>
  <tr>
    <td rowspan="3" style="padding:0px">
        ![""](../images/spacer.gif)
