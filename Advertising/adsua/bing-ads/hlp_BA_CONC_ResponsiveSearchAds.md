...
<table>
  <tr>
    <th scope="col">Asset performance rating</th>
    <th scope="col">Description</th>
  </tr>
  <tr>
    <th scope="row">Low</th>
    <td>This asset's performance is low and we recommend you replace this asset to improve your ad performance.</td>
  </tr>
  <tr>
    <th scope="row">Good</th>
    <td>This asset is performing well. We recommend you keep this asset and add more assets to improve your ad performance.</td>
  </tr>
  <tr>
    <th scope="row">Best</th>
    <td>This asset's performance is among the best and we recommend that you add more similar assets.</td>
  </tr>
  <tr>
    <th scope="row">Unrated</th>
    <td>We don't have any performance rating for this asset. This can be due to the asset being inactive, not having enough information to determine its performance, or if there aren't enough similar assets to compare against it.</td>
  </tr>
</table>
