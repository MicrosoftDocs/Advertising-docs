...
1. In the type list from left pane, click **Locations** and then select the campaigns or ad groups that you want to add location exclusions to.
...
1. In the tree view from the left pane, select the campaigns or ad groups that you want to add website exclusions to.
