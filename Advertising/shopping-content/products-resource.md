...
|<a name="brand" />brand<br/><br/>\<brand\>|The item's brand, manufacturer, or publisher. The string may contain a maximum of 10 words and 1,000 characters. To ensure the string displays well in the UX, you should limit the brand name to no more than 70 characters.|String|Yes
...
|<a name="contentlanguage" />contentLanguage<br/><br/>\<content_language\>|The two-letter [ISO 639-1](http://loc.gov/standards/iso639-2/php/code_list.php) language code for the product. The following are the possible case-insensitive values.<br/><br/><ul><li>de (German)</li><li>en (English)</li><li>fr (French)</li><li>nl (Dutch)</li></ul>Because the language is used to create the product [ID](#productid), you may not change this field after adding the product to the store.|String|Yes
...
|locationId|Gets or sets the ID of the geographic location where the item is being shipped to. For a list of IDs, see [Microsoft Advertising Geographical Location Codes](/advertising/guides/geographical-location-codes).|String|\<location_id\>
...
|locationId|Gets or sets the ID of the geographic location whose tax rate applies. For a list of IDs, see [Microsoft Advertising Geographical Location Codes](/advertising/guides/geographical-location-codes).|Long|\<location_id\>
