...
|<a name="averagecpp"></a>AverageCpp|The average cost per phone call (CPP). This column is applicable solely for manual calls, and does not include clicks-to-call data.<br/><br/>This report column is deprecated in version 12 and not available in version 13.|
...
|<a name="clickcalls"></a>ClickCalls|The number of phone calls initiated by clicks.<br/><br/>This report column is deprecated and will be removed in a future version of the API.|
