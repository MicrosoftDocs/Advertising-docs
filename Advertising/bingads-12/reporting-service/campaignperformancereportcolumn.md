...
|<a name="averagecpp"></a>AverageCpp|The average cost per phone call (CPP). This column is applicable solely for manual calls, and does not include clicks-to-call data.<br/><br/>This report column is deprecated and will be removed in a future version of the API.|
