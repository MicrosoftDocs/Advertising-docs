...
author: eric-urban
ms.author: eur
description: Defines the UpdateImportJobs Service Operation.
dev_langs: 
  - csharp
  - java
  - php
...
|-----------|---------------|-------------|
|<a name="importjobs"></a>ImportJobs|Reserved.|[ImportJob](importjob.md) array|
...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="importjobids"></a>ImportJobIds|Reserved.|**long** array|
