...
author: eric-urban
ms.author: eur
description: Defines the GetImportEntityIdsMapping Service Operation.
dev_langs: 
  - csharp
  - java
  - php
...
Defines the GetImportEntityIdsMapping Service Operation.
...
|-----------|---------------|-------------|
|<a name="importentitytype"></a>ImportEntityType|Reserved.|[ImportEntityType](importentitytype.md)|
|<a name="importtype"></a>ImportType|Reserved.|**string**|
|<a name="returnadditionalfields"></a>ReturnAdditionalFields|Reserved.|[ImportEntityIdMapping](importentityidmapping.md)|
|<a name="sourceentityids"></a>SourceEntityIds|Reserved.|**long** array|
...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="entityidsmapping"></a>EntityIdsMapping|Reserved.|[KeyValuePairOflonglong](keyvaluepairoflonglong.md) array|
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetImportEntityIdsMappingResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <EntityIdsMapping xmlns:e97="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e97:KeyValuePairOflonglong>
          <e97:key>ValueHere</e97:key>
          <e97:value>ValueHere</e97:value>
        </e97:KeyValuePairOflonglong>
      </EntityIdsMapping>
...
public async Task<GetImportEntityIdsMappingResponse> GetImportEntityIdsMappingAsync(
	...
	ImportEntityIdMapping? returnAdditionalFields)
{
...
static GetImportEntityIdsMappingResponse getImportEntityIdsMapping(
	...
	ImportEntityType importEntityType,
	ArrayList<ImportEntityIdMapping> returnAdditionalFields) throws RemoteException, Exception
{
