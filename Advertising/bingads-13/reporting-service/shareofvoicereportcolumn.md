...
|Value|Description|
|-----------|---------------|
|<a name="absolutetopimpressionratepercent"></a>AbsoluteTopImpressionRatePercent|The percentage of times your ad was in the first position of all returned ads, out of the total impressions available in your target market.<br/><br/>A higher number indicates your ad is frequently showing in the best ad position.|
