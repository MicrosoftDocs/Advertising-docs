...
The following example shows how to add targets using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../guides/client-libraries.md).

This example has been developed and run within the environment described in [Get Started Using Python with Bing Ads Services](../guides/get-started-python.md). To get started developing Bing Ads applications with Python, [install the SDK](../guides/get-started-python.md#installation) and either start with the [provided examples](https://help.bingads.microsoft.com/#apex/3/en/n5012/2) or follow one of the application walkthroughs for a [Web](Walkthrough:%20Bing%20Ads%20Web%20Application%20in%20Python.md) or [Desktop](Walkthrough:%20Bing%20Ads%20Desktop%20Application%20in%20Python.md) application.

> [!NOTE]
> This example depends on additional classes such as *auth_helper.py* that you can download from [GitHub](https://help.bingads.microsoft.com/#apex/3/en/n5012/2).
