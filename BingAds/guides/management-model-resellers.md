...
|CustomerId|The identifier of the customer that contains and owns the account. If you manage an account of another customer e.g. child customer created via [SignupCustomer](~/customer-management/signupcustomer.md), you should use that customer ID instead of your own customer ID. |
