...
These are the Bing Ads entities with properties for managing URLs that can be accessed using the [Bulk Service](/binga/bingads/bulk-service/bulk-service-reference.md).
...
-   [Expanded Text Ad](/binga/bingads/bulk-service/expanded-text-ad.md)
-   [Text Ad](/binga/bingads/bulk-service/text-ad.md)
-   [Keyword](/binga/bingads/bulk-service/keyword.md)
-   [Sitelink Ad Extension](/binga/bingads/bulk-service/sitelink-ad-extension.md)
...
These are the Bing Ads entities with properties for managing URLs that can be accessed using the [Campaign Management Service](/binga/bingads/campaign-management-service/campaign-management-service-reference.md). You can create, read, update, and delete these entities.
-  [AdGroup](/binga/bingads/campaign-management-service/adgroup.md)  
-  [AppInstallAd](/binga/bingads/campaign-management-service/appinstallad.md)  
-  [BiddableAdGroupCriterion](/binga/bingads/campaign-management-service/biddableadgroupcriterion.md)  
-  [DynamicSearchAd](/binga/bingads/campaign-management-service/dynamicsearchad.md)  
-  [ExpandedTextAd](/binga/bingads/campaign-management-service/expandedtextad.md)  
-  [Keyword](/binga/bingads/campaign-management-service/keyword.md)  
-  [SiteLink](/binga/bingads/campaign-management-service/sitelink.md)  
-  [Sitelink2AdExtension](/binga/bingads/campaign-management-service/sitelink2adextension.md)  
-  [TextAd](/binga/bingads/campaign-management-service/textad.md)  

## <a name="reportingservice"></a>URL Tracking with the Reporting Service
The following reports can be submitted and downloaded with the [Reporting Service](/binga/bingads/reporting-service/reporting-service-reference.md) to get performance data for Final URLs and Tracking Templates. 

The *TrackingTemplate* and *CustomParameters* columns for upgraded URLs are available in several reports for example, the [AdPerformanceReportColumn](/binga/bingads/reporting-service/adperformancereportcolumn.md).
