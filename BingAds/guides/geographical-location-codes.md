...
If you specified *Version* as 2.0 when calling the [GetGeoLocationsFileUrl](/binga/bingads/campaign-management-service/getgeolocationsfileurl.md) operation, the following data is available in the downloaded file. Bing Ads API Version 11 only supports file format version 2.0.
