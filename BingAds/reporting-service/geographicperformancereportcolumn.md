...
|<a name="metroarea"></a>MetroArea|The metro area where the user was physically located when they clicked the ad.<br/><br/> The *LocationType* column identifies whether the user was located in, searching for, or viewing pages about the location.|
