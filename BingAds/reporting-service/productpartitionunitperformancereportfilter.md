---
title: ProductPartitionUnitPerformanceReportFilter Data Object
...
---
# ProductPartitionUnitPerformanceReportFilter Data Object
...
|<a name="languagecode"></a>LanguageCode|The report will include data for only websites that used the specified languages. For a list of possible values, see [Common Market Values](~/guides/common-market-values.md).|**string**|
