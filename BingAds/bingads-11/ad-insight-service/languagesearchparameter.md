...
If you do not include the language search parameter when calling [GetKeywordIdeas](/bingads/ad-insight-service/getkeywordideas), then keyword ideas will be returned for all languages.
