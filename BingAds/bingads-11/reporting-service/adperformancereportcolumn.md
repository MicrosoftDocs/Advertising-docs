...
Defines the attributes and performance statistics columns that you can include in the [AdPerformanceReportRequest](/bingads/reporting-service/adperformancereportrequest.md).
