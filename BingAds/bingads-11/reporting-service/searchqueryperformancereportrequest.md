...
Since this data might change over time, please use the [KeywordPerformanceReportRequest](/bingads/reporting-service/keywordperformancereportrequest.md) to get the performance metrics for your keywords.
