...
|<a name="scope"></a>Scope|The scope of the report. Use this element to limit the report to include data for one or more accounts.|[AccountReportScope](accountreportscope.md)|
