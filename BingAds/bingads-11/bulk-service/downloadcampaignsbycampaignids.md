...
|<a name="downloadfiletype"></a>DownloadFileType|The format of the download file. For possible values, see [DownloadFileType](bingads/bulk-service/downloadfiletype.md). The default is CSV.|[DownloadFileType](downloadfiletype.md)|
|<a name="formatversion"></a>FormatVersion|The format for records of the download file.<br /><br />As a best practice you should always specify the latest format version. Currently the only supported format version for Bing Ads API Version 10 is 4.0.<br /><br />You should manage records according to the [Bulk File Schema](bingads/bulk-service/bulk-file-schema.md) for the corresponding format version. |**string**|
