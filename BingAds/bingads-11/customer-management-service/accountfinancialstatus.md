...
|<a name="writeoff"></a>WriteOff|The account is past due; however, collection is no longer being pursued. When this status is set, the [AccountLifeCycleStatus](account.md#accountlifecyclestatus) element of the [Account](account.md) will be set to *Inactive*.|
