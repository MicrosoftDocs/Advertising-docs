...
- If the value is *0*, Bing Ads will not append any UTM tracking codes to your ad or keyword final URL.

- If the value is *1*, Bing Ads will automatically append the supported UTM tracking codes, and preserve any existing UTM tracking codes that you added to your ad or keyword's final URL.

- If the value is *2*, Bing Ads will automatically append the supported UTM tracking codes, and replace any of the existing and supported UTM tracking codes that you added to your ad or keyword's final URL.
