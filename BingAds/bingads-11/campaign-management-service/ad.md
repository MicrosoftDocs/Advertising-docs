...
- [ProductAd](bingads/campaign-management-service/productad.md) 
...
|<a name="finalmobileurls"></a>FinalMobileUrls|The mobile landing page URL. <br /><br />Final mobile URLs is only supported for text ads. For more details see [TextAd](bingads/campaign-management-service/textad.md).|**string** array|
|<a name="finalurls"></a>FinalUrls|The last or final URL where a user is ultimately taken, whether or not the click to final URL path included any redirects.<br /><br />Final URLs are only supported for [AppInstallAd](bingads/campaign-management-service/appinstallad.md), [ExpandedTextAd](bingads/campaign-management-service/expandedtextad.md), and [TextAd](bingads/campaign-management-service/textad.md) objects.|**string** array|
...
|<a name="trackingurltemplate"></a>TrackingUrlTemplate|The tracking template to use as a default for all landing page URLs.<br /><br />Tracking template is only supported for [AppInstallAd](bingads/campaign-management-service/appinstallad.md), [DynamicSearchAd](bingads/campaign-management-service/dynamicsearchad.md), [ExpandedTextAd](bingads/campaign-management-service/expandedtextad.md), and [TextAd](bingads/campaign-management-service/textad.md) objects. It is not supported for the [ProductAd](bingads/campaign-management-service/productad.md) object.|**string**|
|<a name="type"></a>Type|The type of the ad. For more information about ad types, see the [Remarks](#remarks).|[AdType](adtype.md)|
|<a name="urlcustomparameters"></a>UrlCustomParameters|Your custom collection of key and value parameters for URL tracking.<br /><br />Custom parameters are only supported for [AppInstallAd](bingads/campaign-management-service/appinstallad.md), [DynamicSearchAd](bingads/campaign-management-service/dynamicsearchad.md), [ExpandedTextAd](bingads/campaign-management-service/expandedtextad.md), and [TextAd](bingads/campaign-management-service/textad.md) objects. They are not supported for the [ProductAd](bingads/campaign-management-service/productad.md) object.|[CustomParameters](customparameters.md)|
