...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="name"></a>Name|The name of the media representation.<br /><br />For [ImageMediaRepresentation](/bingads/campaign-management-service/imagemediarepresentation.md), the possible values are *Preview*, *Thumbnail*, and *Original*.|**string**|
...
|Thumbnail|120|68|
|Preview|160|90|
|Original size that you uploaded using the [AddMedia](/bingads/campaign-management-service/addmedia.md) service operation.|For dimension restrictions, please see [Image](/bingads/campaign-management-service/image.md).|For dimension restrictions, please see [Image](/bingads/campaign-management-service/image.md).|
