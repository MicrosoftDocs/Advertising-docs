...
A [NegativeKeywordList](bingads/campaign-management-service/negativekeywordlist.md) is derived from the [SharedList](bingads/campaign-management-service/sharedlist.md), which derives from the [SharedEntity](bingads/campaign-management-service/sharedentity.md) object.
...
|<a name="type"></a>Type|The type of the shared entity. For more information about shared entity types, see [SharedEntity Data Object Remarks](bingads/campaign-management-service/sharedentity.md#remarks).|**string**|
