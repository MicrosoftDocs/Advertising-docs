...
For code examples that demonstrate how to download the geographical locations codes, see [Geographical Locations Code Example](bingads/guides/code-example-geographical-locations.md).
...
If you specified *Version* as 2.0 when calling the [GetGeoLocationsFileUrl](bingads/campaign-management-service/getgeolocationsfileurl.md) operation, the following data is available in the downloaded file. Bing Ads API Version 11 only supports file format version 2.0.
...
## See Also
[Show Ads to Your Target Audience](bingads/guides/show-ads-target-audience.md)  
