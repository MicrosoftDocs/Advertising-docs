...
Bing Ads API Version 11 is released to production. For more details, see [Migrating to Bing Ads API Version 11](migration-guide.md) and [Bing Ads API Reference](reference.md).
