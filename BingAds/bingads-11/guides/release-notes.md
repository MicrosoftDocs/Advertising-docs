...
Bing Ads API Version 11 is released to production. For more details, see [Migrating to Bing Ads API Version 11](migrate-bing-ads-api-version-11.md) and [Bing Ads API Reference](reference.md).

### <a name="sdk-may2017"></a>Bing Ads PHP Software Development Kit (SDK)
The Bing Ads .NET, Java, and PHP SDKs are updated with support for Bing Ads API Version 11 [web service addresses](web-service-addresses.md). This release enables you to [upgrade](migrate-bing-ads-api-version-11.md) existing features from version 9 and 10 to version 11. 
