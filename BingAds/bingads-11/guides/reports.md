...
With Bing Ads API version 11 the PacificTimeUSCanadaTijuana time zone is used to establish today's date. When you submit the report request today's date can vary around the world depending on the time zone. The report time period that you choose e.g., 'Yesterday' is relative to today's date in the PacificTimeUSCanadaTijuana time zone. For example, a report requested without a time zone specified at 2 AM EasternTimeUSCanada on 9/2/2018 for 'Yesterday' will be interpreted as a request for 8/31/2018. Starting with Bing Ads API version 12 you can choose another time zone.
