...
|Text|The maximum input length is 300 characters including dynamic text strings, and of those 300 no more than 80 final characters are allowed after substitution. For languages with double-width characters e.g. Traditional Chinese the maximum input length is 150 characters including dynamic text strings, and of those 150 no more than 40 final characters are allowed after substitution.|
