...
By default, when you request a list of hotel groups under a subaccount, the API returns a maximum of 1,000 groups. To determine the total number of groups in the subaccount, use the [$count](#count-param) query paramater. To specify the number of groups to return, use the [$top](#top-param) query parameter. The maximum number of groups that you can request in single call is 5,000. If the subaccount contains more than 5,000 groups, use the $top and [$skip](#skip-param) query parameters to page through all groups.
...
By default, when you request a list of hotels in a hotel group, the API returns a maximum of 1,000 hotels. To determine the total number of hotels in the hotel group, use the [$count](#count-param) query paramater. To specify the number of hotels to return, use the [$top](#top-param) query parameter. The maximum number of hotels that you can request in single call is 5,000. If your hotel group contains more than 5,000 hotels, use the $top and [$skip](#skip-param) query parameters to page through all hotels.
...
By default, when you request a list of associations in a subaccount, the API returns a maximum of 1,000 associations. To determine the total number of associations, use the [$count](#count-param) query paramater. To specify the number of associations to return, use the [$top](#top-param) query parameter. The maximum number of associations that you can request in single call is 5,000. If your subaccount contains more than 5,000 associations, use the $top and [$skip](#skip-param) query parameters to page through all associations.
