...
Defines the attributes and performance statistics columns that you can include in the [ProductPartitionUnitPerformanceReportRequest](../reporting/productpartitionunitperformancereportrequest.md).
