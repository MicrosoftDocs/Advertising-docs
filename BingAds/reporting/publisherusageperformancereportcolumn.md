...
Defines the attributes and performance statistics columns that you can include in the [PublisherUsagePerformanceReportRequest](../reporting/publisherusageperformancereportrequest.md).
