...
Defines an association record between an [Ad Group](../bulk/ad-group.md) and an [App Ad Extension](../bulk/app-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or app ad extension, use the [Ad Group](../bulk/ad-group.md) or [App Ad Extension](../bulk/app-ad-extension.md) record.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For an *Ad Group App Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk/bulk-file-schema.md). 
