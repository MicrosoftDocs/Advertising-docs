---
title: "Account Sitelink2 Ad Extension"
ms.service: "bing-ads"
ms.topic: "article"
author: "eric-urban"
ms.author: "eur"
...
Defines an association record between an [Account](../bulk/account.md) and a [Sitelink2 Ad Extension](../bulk/sitelink2-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the account or sitelink2 ad extension, use the [Account](../bulk/account.md) or [Sitelink2 Ad Extension](../bulk/sitelink2-ad-extension.md) record.

> [!NOTE]
> Not everyone has this feature yet. If you don’t, don’t worry. It’s coming soon.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For a *Account Sitelink2 Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk/bulk-file-schema.md). 
