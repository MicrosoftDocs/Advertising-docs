...
Defines an association record between an [Account](../bulk/account.md) and a [Review Ad Extension](../bulk/review-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the account or review ad extension, use the [Account](../bulk/account.md) or [Review Ad Extension](../bulk/review-ad-extension.md) record.

> [!NOTE]
> Not everyone has this feature yet. If you don’t, don’t worry. It’s coming soon.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For a *Account Review Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk/bulk-file-schema.md). 
