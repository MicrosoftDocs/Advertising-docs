...
For a *Keyword* record, the following attribute fields are available in the [Bulk File Schema](../bulk/bulk-file-schema.md). 
...
**Add:** Optional. If you do not specify a keyword level bid, the [Ad Group](../bulk/ad-group.md) bid for the corresponding search or content match type will be used. For more information, see [Budget and Bid Strategies](~/guides/budget-bid-strategies.md).  
...
Possible values include *Active*, *ActiveLimited*, *Disapproved*, and *Inactive*. For more details, see [KeywordEditorialStatus Value Set](~/campaign-management/keywordeditorialstatus.md).
...
**Add:** Read-only and Required. You must either specify an existing ad group identifier, or specify a negative identifier that is equal to the *Id* field of the parent [Ad Group](../bulk/ad-group.md) record. This is recommended if you are adding new keywords to a new ad group in the same Bulk file. For more information, see [Bulk File Schema Reference Keys](~/bulk/bulk-file-schema.md#referencekeys).  
**Update:** Read-only  
**Delete:** Read-only  
...
If the requested download [DataScope Value Set](../bulk/datascope.md) includes *BidSuggestionsData*, the download file will also include the following record types for each corresponding keyword.
* [Keyword Best Position Bid](../bulk/keyword-best-position-bid.md)
* [Keyword Main Line Bid](../bulk/keyword-main-line-bid.md)
* [Keyword First Page Bid](../bulk/keyword-first-page-bid.md)
