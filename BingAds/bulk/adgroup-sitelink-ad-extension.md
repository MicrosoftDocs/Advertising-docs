---
title: "AdGroup Sitelink Ad Extension"
ms.service: "bing-ads"
ms.topic: "article"
author: "eric-urban"
ms.author: "eur"
dev_langs:
  - csharp
---
# AdGroup Sitelink Ad Extension
Defines an association record between an [Ad Group](../bulk/ad-group.md) and a [Sitelink Ad Extension](../bulk/sitelink-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or sitelink ad extension, use the [Ad Group](../bulk/ad-group.md) or [Sitelink Ad Extension](../bulk/sitelink-ad-extension.md) record. 
...
For an *AdGroup Sitelink Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk/bulk-file-schema.md). 
