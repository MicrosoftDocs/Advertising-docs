---
title: "Ad Group Sitelink2 Ad Extension"
ms.service: "bing-ads"
ms.topic: "article"
author: "eric-urban"
ms.author: "eur"
dev_langs:
  - csharp
---
# Ad Group Sitelink2 Ad Extension
Defines an association record between an [Ad Group](../bulk/ad-group.md) and a [Sitelink2 Ad Extension](../bulk/sitelink2-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or sitelink2 ad extension, use the [Ad Group](../bulk/ad-group.md) or [Sitelink2 Ad Extension](../bulk/sitelink2-ad-extension.md) record. 
...
For an *Ad Group Sitelink2 Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk/bulk-file-schema.md). 
