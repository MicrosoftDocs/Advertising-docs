---
title: "Getting a List of Product Offers in Java"
ms.service: "bing-ads"
ms.topic: "article"
author: "eric-urban"
ms.author: "scottwhi"
---
# Getting a List of Product Offers in Java
This example shows how to get a list of product offers from the store using Java. For information about the product-related classes used by this example, see [Products](../shopping-content/products-resource.md#products) and [Product](../shopping-content/products-resource.md#product). For information about getting a list of products, see [Getting a list of product offers from the store](../shopping-content/manage-products.md#list).
...
class ProductsEx {
    ...
    public static final String ListUri = BmcUri + "/products";

    // Query strings. Use the first query string to get the first page of results,
    // and the second to get subsequent pages.
    
    public static final String queryString = "?max-results=250&alt=json";
    public static final String queryStringWithStartToken = "?max-results=250&start-token=%s&alt=json";
	...
	// This example shows how to get a list of products
	...
	public static void main(String[] args) {
		...
		try {
            ...
            String url = String.format(ListUri + queryString, merchantId);

            while (url != null) {
            	
                // Get the list of products.

            	ProductCollection products = (ProductCollection) getResource(url, headers, ProductCollection.class);
            		
                for (Product product : products.getResources())
                {
                ...
                if (products.getNextPageToken() != null)
                {
                    url = String.format(ListUri + queryStringWithStartToken, merchantId, products.getNextPageToken());
                }
                else
                {
                    url = null;
