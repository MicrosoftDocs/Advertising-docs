...
|unitPricingBaseMeasure<br/><br/>\<unit_pricing_base_measure\>|The denominator of the unit price.<br/>|[UnitPricingBaseMeasure](#unitpricing)|No
|unitPricingMeasure<br/><br/>\<unit_pricing_measure\>|The type of measure used to determine the product's unit price. For example, price per ounce.<br/>|[UnitPricingMeasure](#unitpricing)|No
