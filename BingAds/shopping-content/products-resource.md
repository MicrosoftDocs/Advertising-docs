...
|adwordsGrouping<br/><br/>\<adwords_grouping\>|A group of items for Cost-per-acquisition (CPA) bidding.<br/><br/>Bing does not use this field; it's included for Google compatibility.|String|No
|adwordsLabels<br/><br/>\<adwords_label\>|The labels for grouped items (see adwordsGrouping). Applies to Cost-per-click (CPC) only.<br/><br/>Bing does not use this field; it's included for Google compatibility.|String[]|No
