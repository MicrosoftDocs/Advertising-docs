...
Microsoft Advertising Scripts lets you access and manage your Microsoft Advertising data using JavaScript in Microsoft Advertising's browser-based [script editor](./get-started.md).
