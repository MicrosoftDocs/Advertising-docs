...
description: "Provides the basics about using shared budgets in Bing Advertising Scripts."
author: "swhite-msft"
manager: ehansen
...
Campaigns and their budgets are created outside Scripts. When you create a campaign, you specify its budget. If you don't use shared budgets, that's all you do. But if you want to share a budget, you need to create a budget and share it to one or more campaigns. To create a shared budget and associate it with one or more campaigns, use the Bing Advertising web application. For details, see [How do I share a budget across multiple campaigns?](https://help.bingads.microsoft.com/#apex/3/en/56814/1)
