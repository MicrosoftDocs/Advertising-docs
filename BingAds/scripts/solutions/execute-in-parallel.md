...
Before using this example, see [Getting an access token](../examples/accessing-google-services.md) for options on getting an access token to use in this example.
