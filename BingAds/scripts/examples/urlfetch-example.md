...
Before using this example, see [Getting an access token](accessing-goole-services.md#Getting-an-access-token-used-to-access-Google-services) for options on getting an access token to use in this example.
