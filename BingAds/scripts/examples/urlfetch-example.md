...
Before using this example, see [Authenticating with Google services](accessing-google-services.md) for options on getting an access token to use in this example.
