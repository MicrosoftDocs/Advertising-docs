...
Before using this example, see [Getting an access token](accessing-google-services.md#Getting_an_access_token_used_to_access_Google_services) for options on getting an access token to use in this example.
