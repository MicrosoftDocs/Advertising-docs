...
|-----------|---------------|-------------|
|<a name="customeraddress"></a>CustomerAddress|The customer's business address.<br/><br/>This property is not used by Bing Ads, and you must set the account business address instead.<br/><br/>**Add:** Optional<br/>**Update:** Optional|[Address](address.md)|
