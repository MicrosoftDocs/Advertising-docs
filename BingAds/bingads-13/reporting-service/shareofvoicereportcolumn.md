...
> [!NOTE]
> The ImpressionSharePercent, ImpressionLostToBudgetPercent, and ImpressionLostToRankAggPercent columns are the only applicable Share of Voice data available for Bing Ads Shopping Campaigns. 
