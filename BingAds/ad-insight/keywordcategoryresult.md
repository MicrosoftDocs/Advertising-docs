...
|<a name="keywordcategories"></a>KeywordCategories|An array of [KeywordCategory](../ad-insight/keywordcategory.md) objects that contains a keyword category and a score that indicates the confidence that the keyword belongs to that keyword category.|[KeywordCategory](keywordcategory.md) array|
