...
|<a name="criteria"></a>Criteria|The list of campaign level criteria for traffic estimates.<br/><br/>Do not try to instantiate a [Criterion](../ad-insight/criterion.md). You can include one or more the following objects that derive from it: [DeviceCriterion](../ad-insight/devicecriterion.md), [LanguageCriterion](../ad-insight/languagecriterion.md), [LocationCriterion](../ad-insight/locationcriterion.md), and [NetworkCriterion](../ad-insight/networkcriterion.md).<br/><br/>The location, language, and network criterions are required for traffic estimates.|[Criterion](criterion.md) array|
