...
You can specify a network type when calling the [GetKeywordIdeas](../ad-insight/getkeywordideas.md) and [GetKeywordTrafficEstimates](../ad-insight/getkeywordtrafficestimates.md) operations. For more information about networks and ad distribution, see the [About Ad Distribution](http://help.bingads.microsoft.com/#apex/3/en/50871/0) help article.
