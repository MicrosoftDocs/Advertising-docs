...
Use these options to refine what keywords are returned when calling [GetKeywordIdeas](../ad-insight/getkeywordideas.md). You can limit the keyword ideas to include or exclude specific keywords. 
