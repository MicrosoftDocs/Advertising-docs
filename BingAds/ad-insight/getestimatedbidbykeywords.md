...
|-----------|---------------|-------------|
|<a name="keywords"></a>Keywords|A list of [KeywordAndMatchType](../ad-insight/keywordandmatchtype.md) data objects for which you want to get suggested bid values. You may specify a maximum of 1,000 keywords, and each keyword can contain a maximum of 100 characters.|[KeywordAndMatchType](keywordandmatchtype.md) array|
...
|<a name="entitylevelbid"></a>EntityLevelBid|Determines whether to return estimates for keyword level bids, ad group level bids, or both.<br /><br />- Set *EntityLevelBid* to Keyword to get an array of [KeywordEstimatedBid](../ad-insight/keywordestimatedbid.md) corresponding to the specified keywords.<br /><br />- Set *EntityLevelBid* to AdGroup to get one [EstimatedBidAndTraffic](../ad-insight/estimatedbidandtraffic.md) for the specified ad group.<br /><br />- Set *EntityLevelBid* to AllEntities to get an array of [KeywordEstimatedBid](../ad-insight/keywordestimatedbid.md) for keywords and one [EstimatedBidAndTraffic](../ad-insight/estimatedbidandtraffic.md) for an ad group.<br /><br />If you do not set *EntityLevelBid*, the default is to return only an array of [KeywordEstimatedBid](../ad-insight/keywordestimatedbid.md), or the equivalent of setting *EntityLevelBid* to Keyword.<br /><br />If you set *EntityLevelBid* to any value other thanKeyword, AdGroup, or AllEntities, the service will return *Code 3501* with *ErrorCode CampaignServiceBidLevelInvalid*.|**string**|
...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="keywordestimatedbids"></a>KeywordEstimatedBids|An array of [KeywordEstimatedBid](../ad-insight/keywordestimatedbid.md) data objects. The array contains an item for each keyword specified in the request.  If the keyword is not valid, the corresponding item in the array will be null.<br /><br />Each [KeywordEstimatedBid](../ad-insight/keywordestimatedbid.md) contains a keyword and *EstimatedPositions* element. If data is available for the keyword, the [EstimatedPositionAndTraffic](../ad-insight/estimatedpositionandtraffic.md) will provide the suggested bid value that could have resulted in an ad appearing in the targeted position of the search results. Otherwise, the *EstimatedPositions* element will be set to null.|[KeywordEstimatedBid](keywordestimatedbid.md) array|
|<a name="adgroupestimatedbid"></a>AdGroupEstimatedBid|Contains estimates of clicks, average cost per click (CPC), impressions, click-through rate (CTR), and total cost for the specified ad group if you would use the suggested bid.<br /><br />**Note:** The *MatchType* value within the [EstimatedBidAndTraffic](../ad-insight/estimatedbidandtraffic.md) will always be Aggregate. In this context, it represents the default search bid for an ad group.|[EstimatedBidAndTraffic](estimatedbidandtraffic.md)|
...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetEstimatedBidByKeywordsRequest xmlns="Microsoft.Advertiser.AdInsight.Api.Service.V11">
      <Keywords xmlns:e473="http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.V11.Message" i:nil="false">
        <e473:KeywordAndMatchType>
          <e473:KeywordText i:nil="false">ValueHere</e473:KeywordText>
          <e473:MatchTypes i:nil="false">
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetEstimatedBidByKeywordsResponse xmlns="Microsoft.Advertiser.AdInsight.Api.Service.V11">
      <KeywordEstimatedBids xmlns:e474="http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.V11.Entity" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e474:KeywordEstimatedBid>
          <e474:Keyword d4p1:nil="false">ValueHere</e474:Keyword>
          <e474:EstimatedBids d4p1:nil="false">
            <e474:EstimatedBidAndTraffic>
              <e474:MinClicksPerWeek d4p1:nil="false">ValueHere</e474:MinClicksPerWeek>
              <e474:MaxClicksPerWeek d4p1:nil="false">ValueHere</e474:MaxClicksPerWeek>
              <e474:AverageCPC d4p1:nil="false">ValueHere</e474:AverageCPC>
              <e474:MinImpressionsPerWeek d4p1:nil="false">ValueHere</e474:MinImpressionsPerWeek>
              <e474:MaxImpressionsPerWeek d4p1:nil="false">ValueHere</e474:MaxImpressionsPerWeek>
              <e474:CTR d4p1:nil="false">ValueHere</e474:CTR>
              <e474:MinTotalCostPerWeek d4p1:nil="false">ValueHere</e474:MinTotalCostPerWeek>
              <e474:MaxTotalCostPerWeek d4p1:nil="false">ValueHere</e474:MaxTotalCostPerWeek>
              <e474:Currency>ValueHere</e474:Currency>
              <e474:MatchType>ValueHere</e474:MatchType>
              <e474:EstimatedMinBid>ValueHere</e474:EstimatedMinBid>
            </e474:EstimatedBidAndTraffic>
          </e474:EstimatedBids>
        </e474:KeywordEstimatedBid>
      </KeywordEstimatedBids>
      <AdGroupEstimatedBid xmlns:e475="http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.V11.Entity" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e475:MinClicksPerWeek d4p1:nil="false">ValueHere</e475:MinClicksPerWeek>
        <e475:MaxClicksPerWeek d4p1:nil="false">ValueHere</e475:MaxClicksPerWeek>
        <e475:AverageCPC d4p1:nil="false">ValueHere</e475:AverageCPC>
        <e475:MinImpressionsPerWeek d4p1:nil="false">ValueHere</e475:MinImpressionsPerWeek>
        <e475:MaxImpressionsPerWeek d4p1:nil="false">ValueHere</e475:MaxImpressionsPerWeek>
        <e475:CTR d4p1:nil="false">ValueHere</e475:CTR>
        <e475:MinTotalCostPerWeek d4p1:nil="false">ValueHere</e475:MinTotalCostPerWeek>
        <e475:MaxTotalCostPerWeek d4p1:nil="false">ValueHere</e475:MaxTotalCostPerWeek>
        <e475:Currency>ValueHere</e475:Currency>
        <e475:MatchType>ValueHere</e475:MatchType>
        <e475:EstimatedMinBid>ValueHere</e475:EstimatedMinBid>
      </AdGroupEstimatedBid>
...
```csharp
protected async Task<GetEstimatedBidByKeywordsResponse> GetEstimatedBidByKeywordsAsync(
