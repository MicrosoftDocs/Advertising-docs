...
-   [NegativeKeywordList](../campaign-management/negativekeywordlist.md)  

A [NegativeKeywordList](../campaign-management/negativekeywordlist.md) is derived from the [SharedList](../campaign-management/sharedlist.md), which derives from the [SharedEntity](../campaign-management/sharedentity.md) object.
...
|<a name="type"></a>Type|The type of the shared entity. For more information about shared entity types, see [SharedEntity Data Object Remarks](../campaign-management/sharedentity.md#remarks).|**string**|
