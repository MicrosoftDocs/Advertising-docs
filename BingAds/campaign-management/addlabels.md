    ...
    <AddLabelsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e547="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
...
```csharp
protected async Task<AddLabelsResponse> AddLabelsAsync(
	IList<Label> labels)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.AddLabelsAsync(r), request));
}
```
```java
	...
	ArrayOfLabel labels)
{
	...
	return CampaignManagement.getService().addLabels(request);
}
```
```php
