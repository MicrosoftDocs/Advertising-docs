...
- [ProductAd](../campaign-management/productad.md) 
...
|<a name="finalmobileurls"></a>FinalMobileUrls|The mobile landing page URL. <br /><br />Final mobile URLs is only supported for text ads. For more details see [TextAd](../campaign-management/textad.md).|**string**|
|<a name="finalurls"></a>FinalUrls|The last or final URL where a user is ultimately taken, whether or not the click to final URL path included any redirects.<br /><br />Final URLs are only supported for [AppInstallAd](../campaign-management/appinstallad.md), [ExpandedTextAd](../campaign-management/expandedtextad.md), and [TextAd](../campaign-management/textad.md) objects.|**string**|
