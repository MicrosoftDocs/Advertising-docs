      ...
      <CampaignCriterions i:nil="false">
        <CampaignCriterion i:type="-- derived type specified here with the appropriate prefix --">
          ...
          <Criterion i:nil="false" i:type="-- derived type specified here with the appropriate prefix --">
            ...
            <Parameter xmlns:e535="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
              <e535:Conditions i:nil="false">
                <e535:WebpageCondition>
                  <e535:Argument i:nil="false">ValueHere</e535:Argument>
                  <e535:Operand>ValueHere</e535:Operand>
                </e535:WebpageCondition>
              </e535:Conditions>
              <e535:CriterionName i:nil="false">ValueHere</e535:CriterionName>
            </Parameter>
          </Criterion>
	...
	CampaignCriterionType criterionType)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.AddCampaignCriterionsAsync(r), request));
}
```
```java
	...
	CampaignCriterionType criterionType)
{
	...
	return CampaignManagement.getService().addCampaignCriterions(request);
}
```
```php
