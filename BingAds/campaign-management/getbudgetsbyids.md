    ...
    <GetBudgetsByIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e627="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e627:KeyValuePairOfstringstring>
              <e627:key d4p1:nil="false">ValueHere</e627:key>
              <e627:value d4p1:nil="false">ValueHere</e627:value>
            </e627:KeyValuePairOfstringstring>
...
```csharp
protected async Task<GetBudgetsByIdsResponse> GetBudgetsByIdsAsync(
	IList<long> budgetIds)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.GetBudgetsByIdsAsync(r), request));
}
```
```java
	...
	ArrayOflong budgetIds)
{
	...
	return CampaignManagement.getService().getBudgetsByIds(request);
}
```
```php
static function GetBudgetsByIds(
	...
	$getBudgetsByIdsRequest = new GetBudgetsByIdsRequest();

	$request->BudgetIds = $budgetIds;

	return $CampaignManagementProxy->GetService()->GetBudgetsByIds($request);
}
```
```python
