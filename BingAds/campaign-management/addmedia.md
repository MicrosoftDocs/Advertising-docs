...
Adds the specified media to an account?s media library. Depending on the type of [Media](../campaign-management/media.md), you can then add the media to one or more [ImageAdExtension](../campaign-management/imageadextension.md) or [LocationAdExtension](../campaign-management/locationadextension.md) objects.
