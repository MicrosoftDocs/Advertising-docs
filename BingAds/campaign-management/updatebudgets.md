...
|-----------|---------------|-------------|
|<a name="budgets"></a>Budgets|An array of [Budget](../campaign-management/budget.md) objects to update in the account's shared budget library.<br /><br />You can updte a maximum of 100 budgets in a single call. <br/><br/>The account is determined by the required *CustomerAccountId* header element.|[Budget](budget.md) array|
