...
|<a name="associationcount"></a>AssociationCount|The number of [Campaign](../campaign-management/campaign.md) objects that currently share this budget.<br/><br/>**Add:** Read-only<br/>**Update:** Read-only|**int**|
