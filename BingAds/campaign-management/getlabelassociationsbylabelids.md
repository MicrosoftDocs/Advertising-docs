    ...
    <GetLabelAssociationsByLabelIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e652="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e652:KeyValuePairOfstringstring>
              <e652:key d4p1:nil="false">ValueHere</e652:key>
              <e652:value d4p1:nil="false">ValueHere</e652:value>
            </e652:KeyValuePairOfstringstring>
	...
	Paging pageInfo)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.GetLabelAssociationsByLabelIdsAsync(r), request));
}
```
```java
	...
	Paging pageInfo)
{
	...
	return CampaignManagement.getService().getLabelAssociationsByLabelIds(request);
}
```
```php
