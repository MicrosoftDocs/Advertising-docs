...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <AppealEditorialRejectionsRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      <EntityIdToParentIdAssociations xmlns:e556="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
        <e556:EntityIdToParentIdAssociation>
          <e556:EntityId>ValueHere</e556:EntityId>
          <e556:ParentId>ValueHere</e556:ParentId>
        </e556:EntityIdToParentIdAssociation>
	...
	string justificationText)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.AppealEditorialRejectionsAsync(r), request));
}
```
```java
	...
	string justificationText)
{
	...
	return CampaignManagement.getService().appealEditorialRejections(request);
}
```
```php
