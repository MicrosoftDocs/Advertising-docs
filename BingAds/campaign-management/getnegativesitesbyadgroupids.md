    ...
    <GetNegativeSitesByAdGroupIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e658="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e658:KeyValuePairOfstringstring>
              <e658:key d4p1:nil="false">ValueHere</e658:key>
              <e658:value d4p1:nil="false">ValueHere</e658:value>
            </e658:KeyValuePairOfstringstring>
...
static function GetNegativeSitesByAdGroupIds(
	...
	$getNegativeSitesByAdGroupIdsRequest = new GetNegativeSitesByAdGroupIdsRequest();

	$request->CampaignId = $campaignId;
	$request->AdGroupIds = $adGroupIds;

	return $CampaignManagementProxy->GetService()->GetNegativeSitesByAdGroupIds($request);
}
```
```python
