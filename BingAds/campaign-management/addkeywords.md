    ...
    <AddKeywordsRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      ...
      <Keywords i:nil="false">
        <Keyword>
          ...
          <FinalAppUrls xmlns:e543="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
            <e543:AppUrl>
              <e543:OsType i:nil="false">ValueHere</e543:OsType>
              <e543:Url i:nil="false">ValueHere</e543:Url>
            </e543:AppUrl>
          </FinalAppUrls>
          ...
          <ForwardCompatibilityMap xmlns:e544="http://schemas.datacontract.org/2004/07/System.Collections.Generic" i:nil="false">
          ...
          <UrlCustomParameters xmlns:e545="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
            <e545:Parameters i:nil="false">
              <e545:CustomParameter>
...
```csharp
protected async Task<AddKeywordsResponse> AddKeywordsAsync(
	long adGroupId,
	IList<Keyword> keywords)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.AddKeywordsAsync(r), request));
}
```
```java
	...
	ArrayOfKeyword keywords)
{
	...
	return CampaignManagement.getService().addKeywords(request);
}
```
```php
