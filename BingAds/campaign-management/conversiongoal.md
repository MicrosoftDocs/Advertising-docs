...
- [InStoreTransactionGoal](../campaign-management/instoretransactiongoal.md) 
- [OfflineConversionGoal](../campaign-management/offlineconversiongoal.md) 
...
|<a name="tagid"></a>TagId|The unique Bing Ads identifier of the UET tag that you added to your website to allow Bing Ads to collect actions people take on your website.<br/><br/>**Note:** This element is not applicable for the [AppInstallGoal](../campaign-management/appinstallgoal.md) and [OfflineConversionGoal](../campaign-management/offlineconversiongoal.md).|**long**|
