...
Applies an add, update, or delete action to each of the specified [BiddableAdGroupCriterion](../campaign-management/biddableadgroupcriterion.md) or [NegativeAdGroupCriterion](../campaign-management/negativeadgroupcriterion.md), which each contain a [ProductPartition](../campaign-management/productpartition.md).
        ...
        <AdGroupCriterionAction>
          ...
          <AdGroupCriterion i:nil="false" i:type="-- derived type specified here with the appropriate prefix --">
            ...
            <Criterion i:nil="false" i:type="-- derived type specified here with the appropriate prefix --">
              ...
              <Parameter xmlns:e559="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
                <e559:Conditions i:nil="false">
                  <e559:WebpageCondition>
                    <e559:Argument i:nil="false">ValueHere</e559:Argument>
                    <e559:Operand>ValueHere</e559:Operand>
                  </e559:WebpageCondition>
                </e559:Conditions>
                <e559:CriterionName i:nil="false">ValueHere</e559:CriterionName>
              </Parameter>
            </Criterion>
            ...
            <FinalAppUrls xmlns:e560="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
              <e560:AppUrl>
                <e560:OsType i:nil="false">ValueHere</e560:OsType>
                <e560:Url i:nil="false">ValueHere</e560:Url>
              </e560:AppUrl>
            </FinalAppUrls>
            ...
            <UrlCustomParameters xmlns:e561="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" i:nil="false">
              <e561:Parameters i:nil="false">
                <e561:CustomParameter>
                  <e561:Key i:nil="false">ValueHere</e561:Key>
	...
	IList<AdGroupCriterionAction> criterionActions)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.ApplyProductPartitionActionsAsync(r), request));
}
```
```java
static ApplyProductPartitionActionsResponse applyProductPartitionActions(
	ArrayOfAdGroupCriterionAction criterionActions)
{
	...
	return CampaignManagement.getService().applyProductPartitionActions(request);
}
```
```php
