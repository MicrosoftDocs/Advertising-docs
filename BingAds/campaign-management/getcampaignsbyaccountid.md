    ...
    <GetCampaignsByAccountIdResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      <Campaigns d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <Campaign>
          ...
          <UrlCustomParameters xmlns:e633="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" d4p1:nil="false">
            <e633:Parameters d4p1:nil="false">
              <e633:CustomParameter>
	...
	CampaignType campaignType)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.GetCampaignsByAccountIdAsync(r), request));
}
```
```java
	...
	CampaignType campaignType)
{
	...
	return CampaignManagement.getService().getCampaignsByAccountId(request);
}
```
```php
