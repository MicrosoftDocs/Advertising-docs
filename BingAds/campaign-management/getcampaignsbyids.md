...
|<a name="campaignids"></a>CampaignIds|A maximum of 100 identifiers of the campaigns to get from the specified account.<br /><br />The identifiers must correspond to campaigns of the specified *CampaignType* or types, and otherwise the service will return error code *EntityIdFilterMismatch* (Code 516).|**long**|
    ...
    <GetCampaignsByIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      <Campaigns d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <Campaign>
          ...
          <ForwardCompatibilityMap xmlns:e634="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e634:KeyValuePairOfstringstring>
              <e634:key d4p1:nil="false">ValueHere</e634:key>
              <e634:value d4p1:nil="false">ValueHere</e634:value>
            </e634:KeyValuePairOfstringstring>
          ...
          <UrlCustomParameters xmlns:e635="http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts.V11" d4p1:nil="false">
            <e635:Parameters d4p1:nil="false">
              <e635:CustomParameter>
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e636="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e636:KeyValuePairOfstringstring>
              <e636:key d4p1:nil="false">ValueHere</e636:key>
              <e636:value d4p1:nil="false">ValueHere</e636:value>
            </e636:KeyValuePairOfstringstring>
          </ForwardCompatibilityMap>
	...
	CampaignType campaignType)
{
	...
	return (await CampaignManagement.CallAsync((s, r) => s.GetCampaignsByIdsAsync(r), request));
}
```
```java
	...
	CampaignType campaignType)
{
	...
	return CampaignManagement.getService().getCampaignsByIds(request);
}
```
```php
static function GetCampaignsByIds(
	...
	$getCampaignsByIdsRequest = new GetCampaignsByIdsRequest();

	$request->AccountId = $accountId;
	$request->CampaignIds = $campaignIds;
	$request->CampaignType = $campaignType;

	return $CampaignManagementProxy->GetService()->GetCampaignsByIds($request);
}
```
```python
