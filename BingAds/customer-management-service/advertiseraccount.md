...
|<a name="name"></a>Name|The name of the account. The name can contain between 3 and 100 characters and must be unique among all account names within the customer.<br/><br/>**Add:** Required<br/>**Update:** Required|**string**|
