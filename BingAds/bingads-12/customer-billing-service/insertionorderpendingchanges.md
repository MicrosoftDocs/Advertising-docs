...
|-----------|---------------|-------------|
|<a name="changestatus"></a>ChangeStatus|Can be used to accept, decline, or cancel insertion order pending changes.<br/><br/>When you call [UpdateInsertionOrder](updateinsertionorder.md) you can either set this ChangeStatus element or modify other elements of this object, but you cannot change the status in parallel with other property updates.|[InsertionOrderPendingChangesStatus](insertionorderpendingchangesstatus.md)|
