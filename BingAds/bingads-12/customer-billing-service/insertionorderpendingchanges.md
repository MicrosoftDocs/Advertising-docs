...
|-----------|---------------|-------------|
|<a name="changestatus"></a>ChangeStatus|Can be used to accept, decline, or cancel insertion order pending changes.<br/><br/>When you call [UpdateInsertionOrder](updateinsertionorder.md) you can either set the ChangeStatus element or modify the other pending changes elements, but you cannot change the status with other updates.|[InsertionOrderPendingChangesStatus](insertionorderpendingchangesstatus.md)|
...
|<a name="referenceid"></a>ReferenceId|Internal use only.<br/><br/>**Add:** Read-only<br/>**Update:** Read-only|**long**|
