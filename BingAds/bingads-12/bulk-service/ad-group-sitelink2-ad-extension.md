...
Defines an association record between an [Ad Group](/bingads/bulk-service/ad-group.md) and a [Sitelink2 Ad Extension](/bingads/bulk-service/sitelink2-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or sitelink2 ad extension, use the [Ad Group](/bingads/bulk-service/ad-group.md) or [Sitelink2 Ad Extension](/bingads/bulk-service/sitelink2-ad-extension.md) record. 
...
For an *Ad Group Sitelink2 Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](/bingads/bulk-service/bulk-file-schema.md). 
