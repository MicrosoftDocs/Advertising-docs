...
Format Version,,,,,,,,,,,6,,,,
Structured Snippet Ad Extension,Active,-18,0,,,ClientIdGoesHere,,,12/31/2019,,,(Monday[09:00-21:00]),FALSE,Brands,Windows;Xbox;Skype
```

If you are using the [Bing Ads SDKs](../guides/client-libraries.md) for .NET, Java, or Python, you can save time using the [BulkServiceManager](../guides/sdk-bulk-service-manager.md) to upload and download the *BulkStructuredSnippetAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
