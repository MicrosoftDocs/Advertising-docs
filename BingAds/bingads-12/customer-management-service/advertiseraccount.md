...
|<a name="autotagtype"></a>AutoTagType|Determines whether to append or replace the supported UTM tracking codes.<br/><br/>Bing Ads can automatically add UTM tags to your destination URL so you can use your website analytics tool, for example Google Analytics, to track how people got to your website. Auto-tags are applied for example to expanded text ads, keywords, Bing Shopping Campaigns, and Sitelink Extensions. For details about auto-tagging, please see the Bing Ads help article [How do I add UTM tags to my landing page URL?](https://help.bingads.microsoft.com/#apex/3/en/56762/-1).<br/><br/>**Add:** Optional. If not specified the default value is Inactive.<br/>**Update:** Optional. If no value is specified on update, this Bing Ads setting is not changed.|[AutoTagType](autotagtype.md)|
