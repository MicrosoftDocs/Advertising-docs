...
|<a name="writeoff"></a>WriteOff|The account is past due; however, collection is no longer being pursued. When this status is set, the [Status](advertiseraccount.md#status) element of the [AdvertiserAccount](advertiseraccount.md) will be set to *Inactive*.|
