...
|<a name="time"></a>Time|The time period to use for the report. You can specify a custom date range or select a predefined date range, for example, Today or LastSevenDays.<br /><br />For a list of the time periods that you can specify for the Summary aggregation type, see [Aggregation and Time](/bingads/guides/reports.md#aggregation-time).|[ReportTime](reporttime.md)|
