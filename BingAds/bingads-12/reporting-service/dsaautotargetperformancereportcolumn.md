...
Defines the attributes and performance statistics columns that you can include in the [DSAAutoTargetPerformanceReportRequest](/bingads/reporting-service/dsaautotargetperformancereportrequest.md).
