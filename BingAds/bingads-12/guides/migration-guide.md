...
The list of *PublisherCountries* is replaced with a list of *LocationIds* for both the [GetEstimatedBidByKeywords](../ad-insight-service/getestimatedbidbykeywords.md) and [GetEstimatedPositionByKeywordsRequest](../ad-insight-service/getestimatedpositionbykeywords.md) operations. Call the [GetGeoLocationsFileUrl](../campaign-management-service/getgeolocationsfileurl.md) operation with the Campaign Management service to download a CSV file that contains all supported location identifiers. 
