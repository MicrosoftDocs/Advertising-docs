...
The new value set is used with the [GetEstimatedBidByKeywords](../../bingads//ad-insight-service/getestimatedbidbykeywords.md) and [GetEstimatedPositionByKeywordsRequest](../../bingads//ad-insight-service/getestimatedpositionbykeywords.md) operations. 
...
The list of *PublisherCountries* is replaced with a list of *LocationIds* for both the [GetEstimatedBidByKeywords](../../bingads//ad-insight-service/getestimatedbidbykeywords.md) and [GetEstimatedPositionByKeywordsRequest](../../bingads//ad-insight-service/getestimatedpositionbykeywords.md) operations. Call the [GetGeoLocationsFileUrl](../../bingads//campaign-management-service/getgeolocationsfileurl.md) operation with the Campaign Management service to download a CSV file that contains all supported location identifiers. 
...
The *InheritedBidStrategyTypes* element is added to the response message of the [AddKeywords](../../bingads//campaign-management-service/addkeywords.md) and [UpdateKeywords](../../bingads//campaign-management-service/updatekeywords.md) operations.
