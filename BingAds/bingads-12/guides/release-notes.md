...
The [EntityId](../reporting-service/searchcampaignchangehistoryreport.md#entityid) and [EntityName](../reporting-service/searchcampaignchangehistoryreport.md#entityname) elements are added to the [SearchCampaignChangeHistoryReportColumn](../reporting-service/searchcampaignchangehistoryreport.md) value set. 
