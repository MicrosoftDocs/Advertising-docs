...
|-----------|---------------|-------------|
|<a name="currencycode"></a>CurrencyCode|The currency code for the listed price.<br/><br/>For more information, see [Currencies](/bingads/guides/currencies.md).<br/><br/>**Add:** Required<br/>**Update:** Optional. If no value is specified on update, this Bing Ads setting is not changed.|**string**|
...
|<a name="header"></a>Header|The header that precedes the pricing data.<br/><br/>The header can contain a maximum of 25 characters.<br/><br/>The header must tie directly to the [priceextensiontype](/bingads/campaign-management-service/priceextensiontype.md) that you defined for the [PriceAdExtension](/bingads/campaign-management-service/priceadextension.md).<br/><br/>**Add:** Required<br/>**Update:** Optional. If no value is specified on update, this Bing Ads setting is not changed.|**string**|
