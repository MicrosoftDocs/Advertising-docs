...
> [!NOTE]
> The operation is only used for shared negative keyword lists. To get negative keywords that are exclusively used with one campaign or ad group, see [GetNegativeKeywordsByEntityIds](/bingads/campaign-management-service/getnegativekeywordsbyentityids.md). 
    ...
    <GetListItemsBySharedListResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v11">
      <ListItems d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <SharedListItem d4p1:type="-- derived type specified here with the appropriate prefix --">
          <ForwardCompatibilityMap xmlns:e919="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e919:KeyValuePairOfstringstring>
              <e919:key d4p1:nil="false">ValueHere</e919:key>
              <e919:value d4p1:nil="false">ValueHere</e919:value>
            </e919:KeyValuePairOfstringstring>
