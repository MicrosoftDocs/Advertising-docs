...
|-----------|---------------|-------------|
|<a name="sourceid"></a>SourceId|The Bing Ads identifier of the remarketing list that Bing Ads used to generate this similar audience.|**long**|
...
|<a name="id"></a>Id|The Bing Ads identifier of the similar audience.<br/><br/>**Add:** Not supported<br/>**Update:** Not supported|**long**|
...
|<a name="name"></a>Name|The name of the similar audience is set by Bing Ads. The name can contain a maximum of 128 characters.<br/><br/>**Add:** Not supported<br/>**Update:** Not supported|**string**|
