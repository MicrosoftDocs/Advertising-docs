...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="accountproperties"></a>AccountProperties|An array of account properties.<br /><br />For each account property name specified in the request, an [AccountProperty](../campaign-management-service/accountproperty.md) object is returned.|[AccountProperty](accountproperty.md) array|
