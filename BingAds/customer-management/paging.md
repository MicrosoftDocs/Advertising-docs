...
---
# Paging Data Object
Defines a paging object for the list of entities returned using one of the search operations, for example [SearchAccounts](../customer-management/searchaccounts.md), [SearchClientLinks](../customer-management/searchclientlinks.md), or [SearchCustomers](../customer-management/searchcustomers.md).
