...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="usersinfo"></a>UsersInfo|A list of *UserInfo* objects that identifies the list of users who meet the filter criteria.<br /><br />To get the user data for a user in the list, access the *Id* element of the *UserInfo* object and use it to call [GetUser](../customer-management/getuser.md).|[UserInfo](userinfo.md) array|
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetUsersInfoResponse xmlns="https://bingads.microsoft.com/Customer/v11">
      <UsersInfo xmlns:e421="https://bingads.microsoft.com/Customer/v11/Entities" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e421:UserInfo>
          <e421:Id>ValueHere</e421:Id>
          <e421:UserName d4p1:nil="false">ValueHere</e421:UserName>
        </e421:UserInfo>
      </UsersInfo>
	...
	UserLifeCycleStatus statusFilter)
{
	...
	return (await CustomerManagement.CallAsync((s, r) => s.GetUsersInfoAsync(r), request));
}
```
```java
	...
	UserLifeCycleStatus statusFilter)
{
	...
	return CustomerManagement.getService().getUsersInfo(request);
}
```
```php
